// docker-bake.hcl — multi-arch build pipeline for mockta.
//
// Targets:
...
variable "REGISTRY" {
  default = "ghcr.io/donaldgifford/mockta"
}
...
target "_common" {
  ...
  labels = {
    "org.opencontainers.image.source"      = "https://github.com/donaldgifford/mockta"
    "org.opencontainers.image.licenses"    = "Apache-2.0"
    "org.opencontainers.image.description" = "A lightweight, embeddable Okta mock for Terraform acceptance tests and Go service tests"
  }
}
